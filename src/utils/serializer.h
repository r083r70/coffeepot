...
namespace coffeepot
{
    ...
    public:
		...
		static bool saveGlobalOptions(const std::map<std::string, std::string>& globalOptions);
		static bool loadGlobalOptions(std::map<std::string, std::string>& globalOptions);
